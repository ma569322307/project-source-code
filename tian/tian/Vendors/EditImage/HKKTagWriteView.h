...
typedef NS_ENUM(NSInteger, XTTagType) {
    XTTagTypeHorizontalText = 0,
    XTTagTypeReadOnlyHorizontalText,
    XTTagTypeVerticalText,
    XTTagTypeClick,
};
...
//create cyy
@property (nonatomic, assign) XTTagType type;
