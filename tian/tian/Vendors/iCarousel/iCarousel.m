...
- (UIView *)loadViewAtIndex:(NSInteger)index withContainerView:(UIView *)containerView
{
    ...
    if (index < 0)
    {
        if ([_dataSource respondsToSelector:@selector(carousel:placeholderViewAtIndex:reusingView:)]) {
    ...
    {
        if ([_dataSource respondsToSelector:@selector(carousel:viewForItemAtIndex:reusingView:)]) {
