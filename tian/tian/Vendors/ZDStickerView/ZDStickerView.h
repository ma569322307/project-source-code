...
#define kStickerViewBeginMovingNotification @"StickerViewBeginMovingNotification"
#define kStickerViewEndMovingNotification @"StickerViewEndMovingNotification"
typedef enum {
...
@property (nonatomic, assign,getter=isKeepHeight) BOOL keepHeight;
