...
+(instancetype)sharedLocalImageStoreManage{
    static XHNavigationControllerDelegate *_shareManager = nil;
...
- (instancetype)initWithNavigationController:(UINavigationController *)navigationController
    ...
    if (self) {
        ...
        self.navigationController.delegate = [XHNavigationControllerDelegate sharedLocalImageStoreManage];
...
- (id <UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
                                   animationControllerForOperation:(UINavigationControllerOperation)operation
                                                fromViewController:(XTRootViewController *)fromVC
                                                  toViewController:(XTRootViewController *)toVC {
    if (operation == UINavigationControllerOperationPush && fromVC.needTranform) {
        return self.pinterestPushTransition;
    } else if (operation == UINavigationControllerOperationPop && toVC.needTranform) {
