...
- (void)setAssetsGroup:(ALAssetsGroup *)assetsGroup{
    if (_assetsGroup != assetsGroup) {
        ...
        self.assetsNameLabel.xtleft = self.thumbnailView.xtright + 18;
        self.assetsNameLabel.xtbottom = self.thumbnailView.xtcenterY-2;
        
        self.assetsCountLabel.text = [NSString stringWithFormat:@"%ld", (long)[_assetsGroup numberOfAssets]];
        [self.assetsCountLabel sizeToFit];
        self.assetsCountLabel.xtleft = self.assetsNameLabel.xtleft;
        self.assetsCountLabel.xttop = self.assetsNameLabel.xtbottom+4;
...
//        _checkImageView.xtright = self.thumbnailView.xtwidth-3;
//        _checkImageView.xtbottom = self.thumbnailView.xtheight-3;
