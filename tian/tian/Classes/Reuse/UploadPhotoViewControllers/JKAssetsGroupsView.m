...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSUserDefaults standardUserDefaults] setInteger:indexPath.row forKey:kLastPhotoGroup];
...
- (void)setAssetsGroups:(NSArray *)assetsGroups{
    if (_assetsGroups != assetsGroups) {
        ...
        self.tableView.xtheight = rowCount*kHeightAssetsGroupCell;
        self.touchButton.xttop = self.tableView.xtbottom;
        self.touchButton.xtheight = self.xtheight - self.tableView.xtbottom;
        [self.tableView reloadData];
    }
}
...
- (UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.xtwidth, 4*kHeightAssetsGroupCell) style:UITableViewStylePlain];
...
- (UIButton *)touchButton{
    if (!_touchButton) {
        ...
        _touchButton.frame = CGRectMake(0, self.tableView.xtbottom, self.xtwidth, self.xtheight-self.tableView.xtbottom);
